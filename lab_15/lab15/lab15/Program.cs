...
namespace lab15
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Complex c1 = new Complex(x1, y1);//комплексне число
            Complex c2 = new Complex(x2, y2);//комплексне число
            ...
            Complex t1 = new Complex(a, b);//раціональні дроби
            Complex t2 = new Complex(c, d);// раціональні дроби
